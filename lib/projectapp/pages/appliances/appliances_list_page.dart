...
class _AppliancesListPage extends State<AppliancesListPage> {
  ...
  Future<List<Appliances>> getAppliancesList([String query = '']) async {
    try {
      final dio = Dio();
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          Padding(
            ...
            child: TextField(
              onChanged: (value) {
                ...
                getAppliancesList(searchBox);
              },
              decoration: InputDecoration(
                labelText: 'Search Applianaces',
          ...
          Expanded(
            child: FutureBuilder<List<Appliances>>(
              future: getAppliancesList(searchBox),
